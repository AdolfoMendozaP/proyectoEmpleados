                       ...
                       <div class="card" style="width: 100%;">
                         ...
                         try 
                          {
                              ...
                              $query = "SELECT DISTINCT * FROM incapacidad INNER JOIN empleado WHERE empleado.Nombre LIKE '%$busqueda%' OR empleado.Appat LIKE '%$busqueda%' OR empleado.Apmat LIKE '%$busqueda%'";
                        ...
                        <div class="card-footer text-muted">
                           <div class="col-md-12">
                               ...
                               <a class="btn btn-secondary" style="box-shadow: none;" href="../../Vista/incapacidades/index.php"><span><i class="icon icon-Empleados"></i></span> Volver a Incapacidades</a>
