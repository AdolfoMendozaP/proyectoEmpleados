<?php
    ...
    $query = $con->prepare("DELETE FROM empleado WHERE NumEmpleado=?");
    $query->execute([$NumEmpleado]);
    $numElimina = $query->rowCount();
    } 
    
    catch (PDOException $e) 
    {
        echo 'Error de eliminar datos al servidor' .$e->getMessage();
        exit();
    }
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <h3><span><i class="icon icon-Eliminar"></i></span>  Registro eliminado de Datos Laborales</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="card-footer">
                    <a class="btn btn-primary" href="index.php"><span><i class="icon icon-Salir"></i></span>  Regresar al Ingresos Laborales</a>
                </div>
                </div>
            </div>
            </div>
