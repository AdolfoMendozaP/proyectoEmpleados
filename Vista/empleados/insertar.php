             ...
             <div class="row py-3">
                    ...
                    <div class="card">
                      <div class="card-header">
                       <h4><span><i class="icon icon-IngresarEmpleado"></i></span>   Ingresar Datos del Empleado</h4>
                      </div>
                   <div class="card-body">
                       <form class="row g-2" id="Formulario" name="Formulario" action="../../ModeloControlador/modeloControllerEmpleado.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                            <br><br> 
                            <div class="col-md-2">
                           <label for="NumEmpleado" class="form-label" style="font-weight: bold;">#No. Empleado* : </label>
                           <input class="form-control" style="box-shadow: none;" type="text" maxlength="6" title="Tiene que ser numero asignado de Guanuajuato" placeholder="#No. Empleado" required/>
                           </div>
                            <div class="col-md-2">
                            <label for="Nombre" class="form-label" style="font-weight: bold;">Nombre o Nombres* : </label>
                            <input class="form-control" style="text-transform:capitalize; box-shadow: none;" type="text" id="Nombre" name="Nombre" placeholder="Nombre" minlength="4" maxlength="40" pattern="[A-Za-zÀ-ÿ ]{4,40}" title="Ejemplo: Juan Nadie o José María, puedes usar acentos y espacios" required/>
                            </div>
                            <div class="col-md-2">
                            <label for="Appat" class="form-label" style="font-weight: bold;">Apellido Paterno* : </label>
                            <input class="form-control" style="text-transform:capitalize; box-shadow: none;" type="text" id="Appat" name="Appat" placeholder="Apellido Paterno" minlength="4" maxlength="20" pattern="[A-Za-zÀ-ÿ]{4,20}" title="Ejemplo: López o Herrera, puedes usar acentos" required/>
                            </div>
                            <div class="col-md-2">
                            <label for="Apmat" class="form-label" style="font-weight: bold;">Apellido Materno* : </label>
                            <input class="form-control" style="text-transform:capitalize; box-shadow: none;" type="text" id="Apmat" name="Apmat" placeholder="Apellido Materno" minlength="4" maxlength="20" pattern="[A-Za-zÀ-ÿ]{4,20}" title="Ejemplo: Hernández o Castillos, puedes usar acentos" required/>
                            </div>
                            <div class="col-md-2">
                            <label for="RFC" class="form-label" style="font-weight: bold;">RFC* : </label>
                            <input class="form-control" style=" text-transform: uppercase; box-shadow: none;" type="text" id="RFC" name="RFC" placeholder="RFC" minlength="13" maxlength="13" pattern="[A-Za-z0-9]{13}" title="El RFC debe llevar 13 caracteres. Ejemplo: ABCD123456XYZ" oninput="validarInputRFC(this)" required/>
                            <pre id="resultadoR" class="badge bg-danger text-wrap"></pre>
                            </div>
                            <div class="col-md-2">
                            <label for="CURP" class="form-label" style="font-weight: bold;">CURP* : </label>
                            <input class="form-control" style="text-transform:uppercase; box-shadow: none;" type="text" id="CURP" name="CURP" placeholder="CURP" minlength="18" maxlength="18" pattern="[A-Za-z0-9]{18}" title="El CURP debe llevar 18 caracteres. Ejemplo: ABCD123456XYZ12345" oninput="validarInputCurp(this)" required/>
                            <pre id="resultadoC" class="badge bg-danger text-wrap"></pre>
                            </div>
                            <div class="col-md-2">
                            <label for="CUIP" class="form-label" style="font-weight: bold;">CUIP* : </label>
                            <input class="form-control" style="text-transform:uppercase; box-shadow: none;" type="text" id="CUIP" name="CUIP" placeholder="CUIP" minlength="19" maxlength="19" pattern="[A-Za-z0-9]{19}" title="El CUIP debe llevar 19 caracteres. Ejemplo: ABCD123456XYZ123456" oninput="validarInputCuip(this)" required/>
                            </div>
                            <div class="col-md-1">
                            <label for="Nivel" class="form-label" style="font-weight: bold;">Nivel* : </label>
                            <input class="form-control" style="text-transform:uppercase; box-shadow: none;" type="text" id="Nivel" name="Nivel" placeholder="Nivel" maxlength="3" pattern="\d[a-z A-Z0-9]" title="Ejemplo: 1 o 4A, dependiendo de su area asignada" required/>
                            </div>
                            <div class="col-md-3">
                            <label for="Codigo" class="form-label" style="font-weight: bold;">Codigo Presupuestal* : </label>
                            <input class="form-control" style="text-transform:uppercase; box-shadow: none;" type="text" id="Codigo" name="Codigo" placeholder="Codigo Presupuestal" minlength="29" maxlength="29" pattern="[a-zA-Z0-9. ]{29}"title="El Codigo Presupuestal debe llevar 29 caracteres. Ejemplo: ABCD.1234.XYZ" required/>   
                            </div>
                            <div class="col-md-4">
                            <label for="Puesto" class="form-label" style="font-weight: bold;">Puesto* : </label>
                            <select class="form-select" style="box-shadow: none;" name="Puesto" id="Puesto" title="Debes Elegir el Puesto o Denominacion" required>
                            ...
                            <option value="TRABAJADOR/A SOCIAL III">TRABAJADOR/A SOCIAL III</option>
                            <option value="TRABAJADOR/A SOCIAL IV">TRABAJADOR/A SOCIAL IV</option>
                            ...
                            <select class="form-select" style="box-shadow: none;" autofocus name="PuestoFuncional" id="PuestoFuncional" title="Debes Elegir el Puesto Funcional" required>
                            ...
                            <input class="form-control" style="box-shadow: none;" type="date" id="FechaIngreso" name="FechaIngreso" min="1990-01-01" max="2090-12-31" pattern="\d{4}-\d{2}-\d{2}" required/>
                            </div>
                            <div class="col-md-3">
                            <label for="Antiguedad" class="form-label" style="font-weight: bold;">Antigüedad : </label>
                            <input class="form-control" style="box-shadow: none;" type="text" id="Antiguedad" name="Antiguedad" placeholder="Antigüedad" value="0" readonly required/>
                            <pre id="valido"></pre>
                            </div>
                            ...
                            <input class="form-control" style="box-shadow: none;" type="date" id="FechaHoy" value="FechaHoy" name="FechaHoy" min="1990-01-01" max="2090-12-31" pattern="\d{4}-\d{2}-\d{2}" readonly required/>
                            </div>
                            <div class="col-md-2">
                            <label for="FechaPro" class="form-label" style="font-weight: bold;">Fecha de Promocion : </label>
                            <input class="form-control" style="box-shadow: none;" type="date" id="FechaPro" value="FechaPro" name="FechaPro" min="1990-01-01" max="2090-12-31" pattern="\d{4}-\d{2}-\d{2}" required/>
                            </div>
                             <div class="col-md-3">
                            <label for="TurnoArea" class="form-label" style="font-weight: bold;">Turno - Area* : </label>
                            <select class="form-select" style="box-shadow: none;" name="TurnoArea" id="TurnoArea" title="Debes Elegir el Turno - Area" required>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" style="background-color: green;" id="StatusEm" type="radio" name="StatusEm" value="Activo" checked readonly required/>Activo<br>
                            <br>
                            </div>
                            </div>
                            <div class="col-md-2">
                            <input class="form-control" style="box-shadow: none;" type="hidden" id="FechaBaja" name="FechaBaja" min="1990-01-01" max="2090-12-31" readonly/>
                            </div>
                            <div class="col-md-2">
                                <input class="form-control" style="text-transform:capitalize; box-shadow: none;" type="hidden" id="MotivoBaja" name="MotivoBaja" placeholder="MotivoBaja" value="Null" readonly/>
                            </div>
                            <br><br>
                            <div class="form-group col-md-13">
                            <label for="Foto" class="form-label" style="font-weight: bold;">Foto del Empleado* : </label>
                            <input class="form-control" style="box-shadow: none;" type="file" accept=".png, .jpg, .jpeg" id="Foto" name="Foto" required/>
                            <div class="text-center">
                            <img class="rounded" src="../../Resource/assets/imagenes/Logos/camara.png" width="250px" height="250px" id="FotoPreview" alt="">
                            </div>
                            </div>
                       ...
                       <script lang="javascript" type="text/javascript">
                           ...
                           try 
                           {
                            ...
                            //-- Validador de CUIP --//
                                try 
                                {
                                    function cuipValida(cuip)
                                    {
                                        var re = /^([A-Z][AEIOUX][A-Z]{2}\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])[HM](?:AS|B[CS]|C[CLMSH]|D[FG]|G[TR]|HG|JC|M[CNS]|N[ETL]|OC|PL|Q[TR]|S[PLR]|T[CSL]|VZ|YN|ZS)[B-DF-HJ-NP-TV-Z]{3}[A-Z\d])(\d)$/,
                                            validado = cuip.match(re);
                                    
                                        if (!validado)
                                            return false;
                                        
                                        function digitoVerificador(cuip17)
                                        {
                                            var diccionario  = "0123456789ABCDEFGHIJKLMNÑOPQRSTUVWXYZ",
                                                lngSuma = 0.0,
                                                lngDigito = 0.0;
                                            ...
                                            for (var i=0; i<17; i++)
                                                lngSuma = lngSuma + diccionario.indexOf(cuip17.charAt(i)) * (18 - i);
                                            lngDigito = 10 - lngSuma % 10;
                                            if (lngDigito == 0) return 0;
                                            return lngDigito;
                                       } 
                                   ...
                                   function validarInputCuip(input)
                                   {
                                       var cuip = input.value.toUpperCase(),
                                           resultadoCI = document.getElementById("resultadoCI"),
                                           valido = "No valido";
                                   
                                        if (cuipValida(cuip)) 
                                        {
                                             valido = "Válido";
                                             resultadoCI.classList.add("ok");
                                        } 
                                        else 
                                        {
                                            resultadoCI.classList.remove("ok");
                                        }
                                        
                                        resultadoCI.innerText = "*CUIP: " + cuip + "\nFormato: " + valido;
                                   }
                                }
                                catch (err) 
                                {
                                    document.getElementById("CUIP").innerHTML = err.message;
                                }
                           ...
                           try 
                           {
                               function validarFormulario()
                               {
                                   ...
                                   var expFechaPro = /\d{4}-\d{2}-\d{2}/;
                                   var expFechaHoy = /\d{4}-\d{2}-\d{2}/;
                                   ...
                                   var FechaPro = document.getElementById("FechaPro");
                                   ...
                                   if(!expFechaPro.exec(FechaPro.value))
                                   {
                                       FechaPro.focus();
                                       return false;
                                   }
                                   
                                   if(!expFechaHoy.exec(FechaHoy.value))
                                   {
                                       FechaHoy.focus();
                                       return false;
                                   }
                           ...
                           {
                               document.getElementById("Formulario").innerHTML = err.message;
                           }
