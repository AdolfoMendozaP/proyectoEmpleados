<?php
    ...
    $query = $con->prepare("DELETE FROM personales WHERE NumPersonal=?");
    $query->execute([$NumPersonal]);
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <h3><span><i class="icon icon-Eliminar"></i></span>  Registro eliminado de Datos Personales</h3>
                        </div>
                        <div class="card-body">
